<h1>:green_book: BookCord - 도서 정보 제공 & 독서 기록 플랫폼</h1>
...
- 장르별 베스트 셀러 페이지 : 총 20의 장르, 알라딘 API를 활용한 총 100개의 도서 리스트, 북마크
- 장르별 신간 도서 페이지 : 총 20의 장르, 알라딘 API를 활용한 총 100개의 도서 리스트, 북마크
- 도서 검색 결과 페이지 : 알라딘 API를 활용한 도서 검색 결과 수, 키워드에 따른 도서 리스트, 북마크
- 도서 상세 정보 페이지 : 알라딘 API를 활용한 도서 상세 정보, 북마크, 별점을 포함한 리뷰
